...
本文介绍 CSD2-N96 BMC 固件升级流程。升级方式主要分为两类：
...
- 瑞芯微官方升级工具。
- Windows 或 Linux 主机。
- 与 CSD2-N96 BMC 匹配的固件，例如 `update.img`。
...
![连接 OTG 接口](../../../servers_img/CSD2-N96/bmc_upgrade/bmc_upgrade_usb_port.png)
...
<CodeBlockTabs defaultValue="loader_by_cmd">
  ...
  <CodeBlockTab value="loader_by_button">
    ...
    ![RECOVER 按键位置](../../../servers_img/CSD2-N96/bmc_upgrade/loader_recovery_button.png)
  </CodeBlockTab>
</CodeBlockTabs>
