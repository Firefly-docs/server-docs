...
| 章节 | 内容 |
| --- | --- |
| [基本资源](basicResources.mdx) | Redfish 版本入口和 Service Root。 |
| [机箱资源](chassisResources.mdx) | 机箱状态、风扇、UID 和总电源管理。 |
| [系统资源](systemResources.mdx) | 系统状态、网络、时间、磁盘、电源、端口映射和服务管理。 |
| [管理资源](managerResources.mdx) | BMC 管理资源和日志资源。 |
| [OEM 资源](oemResources.mdx) | 远程管理和告警等 Firefly 扩展能力。 |
| [用户资源](accountResources.mdx) | 角色、账号和用户服务管理。 |
| [交换机资源](switchResources.mdx) | 交换机二层、三层、VLAN 和聚合管理。 |
| [升级管理资源](upgradesResources.mdx) | 固件查询、升级状态和升级操作。 |
