...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![打开端口映射页面](../../../aBMC_img/v3.0/portForwarding_img/01-enter-port-forwarding-en-steps-v3.png)
...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![配置端口映射](../../../aBMC_img/v3.0/portForwarding_img/02-add-port-forwarding-en-steps-v3.png)
...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![管理端口映射规则](../../../aBMC_img/v3.0/portForwarding_img/03-manage-port-forwarding-en-steps-v3.png)
    ...
    ![批量管理端口映射规则](../../../aBMC_img/v3.0/portForwarding_img/04-batch-manage-port-forwarding-en-steps-v3.png)
