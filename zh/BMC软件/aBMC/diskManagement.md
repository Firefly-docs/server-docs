...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![进入磁盘管理状态视图](../../../aBMC_img/v3.0/diskManagement_img/01-enter-disk-manager-en-steps-v9.png)
...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![查看磁盘状态](../../../aBMC_img/v3.0/diskManagement_img/00-status-view-en-steps-v2.png)
...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![物理视图总览](../../../aBMC_img/v3.0/diskManagement_img/02-physical-view-overview-en-steps-v9.png)
    ...
    ![创建分区](../../../aBMC_img/v3.0/diskManagement_img/03-create-partition-en-steps-v9.png)
    ...
    ![格式化分区](../../../aBMC_img/v3.0/diskManagement_img/04-format-partition-en-steps-v9.png)
    ...
    ![修改卷标](../../../aBMC_img/v3.0/diskManagement_img/05-modify-label-en-steps-v9.png)
    ...
    ![挂载分区](../../../aBMC_img/v3.0/diskManagement_img/06-mount-partition-en-steps-v9.png)
    ...
    ![查看 Udev 信息](../../../aBMC_img/v3.0/diskManagement_img/07-udev-info-en-steps-v9.png)
    ...
    ![查看 SMART 信息](../../../aBMC_img/v3.0/diskManagement_img/08-smart-info-en-steps-v9.png)
...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![创建 RAID 阵列](../../../aBMC_img/v3.0/diskManagement_img/09-create-raid-array-en-steps-v9.png)
    ...
    ![查看 RAID 阵列卡片](../../../aBMC_img/v3.0/diskManagement_img/10-raid-card-overview-en-steps-v9.png)
    ...
    ![查看 RAID 操作菜单](../../../aBMC_img/v3.0/diskManagement_img/11-raid-operation-menu-en-steps-v9.png)
    ...
    ![添加磁盘](../../../aBMC_img/v3.0/diskManagement_img/12-add-disk-en-steps-v9.png)
    ...
    ![选择旧成员盘](../../../aBMC_img/v3.0/diskManagement_img/13-replace-disk-select-old-en-steps-v9.png)

    1. 在第二步中选择用于替换的新硬盘。
    2. 确认新硬盘与旧成员盘一一对应。
    3. 单击 **Confirm** 提交更换。

    ![选择新硬盘](../../../aBMC_img/v3.0/diskManagement_img/14-replace-disk-select-new-en-steps-v9.png)
    ...
    ![添加硬盘扩容](../../../aBMC_img/v3.0/diskManagement_img/15-expand-disk-en-steps-v9.png)
    ...
    ![修改 RAID 模式](../../../aBMC_img/v3.0/diskManagement_img/16-modify-raid-mode-en-steps-v9.png)
    ...
    ![选择新增硬盘](../../../aBMC_img/v3.0/diskManagement_img/16-modify-raid-mode-select-disk-en-steps-v9.png)
    ...
    ![删除 RAID 成员盘](../../../aBMC_img/v3.0/diskManagement_img/17-remove-member-disk-en-steps-v10.png)
    ...
    ![删除 RAID 阵列](../../../aBMC_img/v3.0/diskManagement_img/18-delete-raid-array-en-steps-v9.png)
