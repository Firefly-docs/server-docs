...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![进入 Network 页面：1 选择 Devices，2 选择 Network，3 搜索或刷新，4 查看网络列表](../../../aBMC_img/v3.0/subNetwork_img/01-enter-sub-network-en-steps-v3.png)
    ...
    ![配置单个网卡：1 IPv4 模式，2 地址，3 子网掩码，4 网关，5 网关优先级，6 DNS，7 确定，8 取消](../../../aBMC_img/v3.0/subNetwork_img/02-edit-sub-network-en-steps-v3.png)
    ...
    ![配置当前选中网卡的 DNS 字段：1 DNS，2 确定，3 取消](../../../aBMC_img/v3.0/subNetwork_img/04-configure-sub-network-dns-en-steps-v3.png)
...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![文件操作与导入限制：1 Export Data，2 Export Template，3 Import，4 Android 子板不支持导入且仅支持 Linux 设备](../../../aBMC_img/v3.0/subNetwork_img/03-batch-import-sub-network-en-steps-v3.png)
