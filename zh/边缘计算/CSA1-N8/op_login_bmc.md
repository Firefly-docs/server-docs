...
<table border="1" cellPadding="8" cellSpacing="0" width="100%">
  ...
  <tbody>
    ...
    <tr>
      <td rowSpan="2">aBMC 管理网口 IPv4 地址<br/> GE M 网口</td>
...
### 1.1 环境准备
#### 1.1.1 服务器网络接线
登录前将 aBMC 管理网口接入局域网，保证操作PC与BMC管理IP互通。
...
- **专用eth0网口**：独立硬件网口，仅传输BMC管理指令，隔离业务网络。

#### 1.1.2 查询aBMC管理IP
可在服务器本地Linux系统执行 `ip` / `ifconfig` 命令，读取eth0网口IP地址。
