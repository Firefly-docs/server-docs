...
This document describes the BMC firmware upgrade procedure for the CSB2-N10. There are two main upgrade methods:
...
- Firmware that matches the CSB2-N10 BMC, for example `update.img`.
...
![Connect the OTG port](../../../servers_img/CSB2-N10/bmc_upgrade/bmc_upgrade_usb_port.png)
...
<CodeBlockTabs defaultValue="loader_by_cmd">
  ...
  <CodeBlockTab value="loader_by_button">
    ...
    ![Location of the RECOVER button](../../../servers_img/CSB2-N10/bmc_upgrade/loader_recovery_button.png)
  </CodeBlockTab>
</CodeBlockTabs>
