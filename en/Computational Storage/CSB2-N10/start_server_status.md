...
![BMC status indicator](../../../servers_img/CSB2-N10/front_view_led_bmc.png)
...
## Sub-board Status Indicators [step]

![Sub-board status indicators](../../../servers_img/CSB2-N10/front_view_led_subboard.png)
...
## Switch Indicator [step]

![Switch indicator](../../../servers_img/CSB2-N10/front_view_led_switch.png)
...
## 10G Port Indicators [step]

![Correspondence between the S1 indicator and the SFP+1 port](../../../servers_img/CSB2-N10/front_view_led_sfp1.png)

![Correspondence between the S2 indicator and the SFP+2 port](../../../servers_img/CSB2-N10/front_view_led_sfp2.png)
...
## UID Button/Indicator [step]

![UID button/indicator](../../../servers_img/CSB2-N10/front_view_led_uid.png)
...
## Sub-board Power Button/Indicator [step]

![Sub-board power button/indicator](../../../servers_img/CSB2-N10/front_view_led_power.png)
