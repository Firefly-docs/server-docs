...
- Firmware that matches the CSB1-N10NOrinNX BMC, for example `update.img`.
...
![Connect the OTG port](../../../servers_img/CSB1-N10NOrinNX/bmc_upgrade/bmc_upgrade_usb_port.png)
...
<CodeBlockTabs defaultValue="loader_by_cmd">
  ...
  <CodeBlockTab value="loader_by_button">
    ...
    ![Location of the RECOVER button](../../../servers_img/CSB1-N10NOrinNX/bmc_upgrade/loader_recovery_button.png)
  </CodeBlockTab>
</CodeBlockTabs>
