...
This document describes the BMC firmware upgrade procedure for the CSB1-N10. There are two main upgrade methods:
...
- Firmware that matches the CSB1-N10 BMC, for example `update.img`.
