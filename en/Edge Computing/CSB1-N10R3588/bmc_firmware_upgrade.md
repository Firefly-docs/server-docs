...
This document describes the BMC firmware upgrade procedure for the CSB1-N10R3588. There are two main upgrade methods:
...
- Firmware that matches the CSB1-N10R3588 BMC, for example `update.img`.
...
![Connect the OTG port](../../../servers_img/CSB1-N10R3588/bmc_upgrade/bmc_upgrade_usb_port.png)
...
<CodeBlockTabs defaultValue="loader_by_cmd">
  ...
  <CodeBlockTab value="loader_by_button">
    ...
    ![Location of the RECOVER button](../../../servers_img/CSB1-N10R3588/bmc_upgrade/loader_recovery_button.png)
  </CodeBlockTab>
</CodeBlockTabs>
