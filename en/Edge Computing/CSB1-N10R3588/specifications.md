...
| **Serial Interfaces** | - 1 × RS232 DB9 interface<br/>- 1 × RS485 DB9 interface |
...
| Item | Specification |
| :--- | :--- |
| **Dimensions (H×W×D)** | Chassis: 44.4mm (1U) × 440.5mm × 494.0mm |
...
| **Weight (Fully Configured)** | - Net weight: 8.1kg<br/>- Packaging material weight: 10.3kg |
...
![perspective view](../../../servers_img/CSB1-N10R3588/hw_logical_topology.png)
...
#### Hard Drive Location
![perspective view](../../../servers_img/CSB1-N10R3588/harddisk_location.png)
...
![SATA Hard Disk Indicator Location Diagram](../../../servers_img/CSB1-N10R3588/sata_hdd_indicator.png)
...
| Marking | Interface Name | Description |
| :--- | :--- | :--- |
| 232 | DB9 | - Baud rate 115200 |
| 485 | DB9 | - Baud rate 115200 |