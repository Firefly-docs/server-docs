...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![查看设备时间状态](../../../img/aBMC_img/v3.0/timeManager_img/01-view-time-manager-en-steps-v2.png)
...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![打开单设备时间设置](../../../img/aBMC_img/v3.0/timeManager_img/02-open-time-settings-en-steps-v2.png)
    ...
    ![配置 NTP 自动同步](../../../img/aBMC_img/v3.0/timeManager_img/03-configure-ntp-en-steps-v2.png)
    ...
    ![配置高级 NTP 参数](../../../img/aBMC_img/v3.0/timeManager_img/04-configure-advanced-ntp-en-steps-v2.png)
    ...
    ![手动设置设备时间](../../../img/aBMC_img/v3.0/timeManager_img/05-configure-manual-time-en-steps-v2.png)
...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![打开批量时间设置](../../../img/aBMC_img/v3.0/timeManager_img/06-open-batch-time-settings-en-steps-v2.png)
    ...
    ![配置批量设备时间](../../../img/aBMC_img/v3.0/timeManager_img/07-configure-batch-time-en-steps-v2.png)
