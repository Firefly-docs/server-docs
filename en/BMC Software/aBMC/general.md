...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![查看常规配置页面](../../../img/aBMC_img/v3.0/general_img/01-view-general-settings-en-steps-v1.png)
...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    **Shortcuts** 列中的图标按以下顺序显示。将鼠标指针停留在图标上，可以查看对应的英文提示。
    ...
    ![识别设备快捷方式](../../../img/aBMC_img/v3.0/general_img/04-view-shortcuts-en-steps-v1.png)
    ...
    ![打开设备 Shell](../../../img/aBMC_img/v3.0/general_img/05-open-shell-en-steps-v1.png)
    ...
    ![查看 System Check](../../../img/aBMC_img/v3.0/general_img/06-view-system-check-en-steps-v1.png)
    ...
    ![打开设备 Info](../../../img/aBMC_img/v3.0/general_img/07-open-device-info-en-steps-v1.png)
...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![打开启动策略设置](../../../img/aBMC_img/v3.0/general_img/02-open-boot-policy-setting-en-steps-v1.png)
    ...
    ![配置设备启动策略](../../../img/aBMC_img/v3.0/general_img/03-configure-boot-policy-en-steps-v1.png)
