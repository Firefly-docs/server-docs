...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![Open the Casting page](../../../img/aBMC_img/v3.0/casting_img/01-enter-casting-en-steps-v3.png)
    ...
    ![Filter and identify an Android device](../../../img/aBMC_img/v3.0/casting_img/02-select-android-device-en-steps-v3.png)
    ...
    **Device** 区域中的快捷项用于改变已选设备，不会隐藏设备列表。
    ...
    ![Start and stop a live Casting session](../../../img/aBMC_img/v3.0/casting_img/03-start-stop-casting-en-steps-v3.png)
    ...
    ![Start and stop Casting for multiple Android devices](../../../img/aBMC_img/v3.0/casting_img/03-batch-casting-en-steps-v3.png)
...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![Use Multi Control, Preview, and Stop Casting](../../../img/aBMC_img/v3.0/casting_img/04-live-preview-controls-en-steps-v4.png)
    ...
    ![Use the expanded Casting preview and device quick controls](../../../img/aBMC_img/v3.0/casting_img/05-expanded-preview-toolbar-en-steps-v3.png)
    ...
    ![Select the source and target devices for Multi Control](../../../img/aBMC_img/v3.0/casting_img/05-multi-control-source-target-en-steps-v3.png)
...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![Send files to selected Android devices](../../../img/aBMC_img/v3.0/casting_img/06-send-file-en-steps-v3.png)
    ...
    ![Install APK files on selected Android devices](../../../img/aBMC_img/v3.0/casting_img/07-install-apk-en-steps-v3.png)
    ...
    ![Execute and review an ADB Shell command](../../../img/aBMC_img/v3.0/casting_img/08-adb-shell-en-steps-v3.png)
...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![Scan Wi-Fi Android devices](../../../img/aBMC_img/v3.0/casting_img/09-scan-wifi-en-steps-v3.png)
    ...
    ![Set the label and link a Wi-Fi Android device](../../../img/aBMC_img/v3.0/casting_img/09-connect-wifi-en-steps-v4.png)
    ...
    ![Create a Casting device group](../../../img/aBMC_img/v3.0/casting_img/10-add-group-en-steps-v4.png)
    ...
    ![Assign selected devices to a Casting group](../../../img/aBMC_img/v3.0/casting_img/11-set-group-en-steps-v3.png)
