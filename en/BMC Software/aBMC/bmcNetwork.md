...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![进入 BMC 网络管理页面：1 选择 System，2 选择 Network，3 选择 Net Manage，4 选择网口，5 打开设置](../../../img/aBMC_img/v3.0/bmcNetwork_img/01-enter-bmc-network-en-steps-v3.png)
    ...
    ![配置 BMC 网卡：1 IPv4 Configuration，2 IPv4 模式，3 地址、子网掩码、网关和优先级，4 DNS，5 取消，6 确认](../../../img/aBMC_img/v3.0/bmcNetwork_img/02-configure-bmc-network-en-steps-v3.png)
...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![打开 Bond Manage：1 选择 System，2 选择 Network，3 选择 Bond Manage，4 选择设备，5 新增，6 修改，7 删除](../../../img/aBMC_img/v3.0/bmcNetwork_img/03-view-bmc-bond-en-steps-v2.png)
    ...
    ![新增 Bond 设备：1 设备名称，2 成员网口，3 聚合模式，4 IPv4 模式，5 IPv4 参数，6 DNS，7 取消，8 新增](../../../img/aBMC_img/v3.0/bmcNetwork_img/04-add-bmc-bond-en-steps-v2.png)

    ### 修改或删除 Bond 设备 [step]

    修改 Bond 时，设备名称不可更改，可调整成员网口、聚合模式和 IPv4 参数。至少选择两个可用成员网口后，**Modify** 才可提交。

    ![修改 Bond 设备：1 当前设备名称，2 成员网口，3 聚合模式，4 IPv4 模式，5 IPv4 参数，6 DNS，7 取消，8 修改](../../../img/aBMC_img/v3.0/bmcNetwork_img/05-configure-bmc-bond-en-steps-v2.png)
...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![打开 VLAN Manage：1 选择 System，2 选择 Network，3 选择 VLAN Manage，4 选择 VLAN，5 新增，6 修改，7 删除](../../../img/aBMC_img/v3.0/bmcNetwork_img/06-view-bmc-vlan-en-steps-v2.png)
    ...
    ![新增 VLAN 设备：1 VLAN ID，2 设备名称，3 VLAN Link，4 IPv4 模式，5 IPv4 参数，6 DNS，7 取消，8 新增](../../../img/aBMC_img/v3.0/bmcNetwork_img/07-add-bmc-vlan-en-steps-v2.png)
