...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![打开文件共享服务端页面](../../../img/aBMC_img/v3.0/fileshare_img/01-open-file-share-server-en-steps-v3.png)
...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![设置 NFS 共享服务](../../../img/aBMC_img/v3.0/fileshare_img/03-set-nfs-service-en-steps-v3.png)
    ...
    ![新增 NFS 共享](../../../img/aBMC_img/v3.0/fileshare_img/02-add-nfs-share-en-steps-v3.png)
...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![查看 CIFS 共享](../../../img/aBMC_img/v3.0/fileshare_img/04-view-cifs-share-en-steps-v3.png)
    ...
    ![新增 CIFS 共享](../../../img/aBMC_img/v3.0/fileshare_img/05-add-cifs-share-en-steps-v3.png)
...
<CodeBlockTabs defaultValue="WEB">
  ...
  <CodeBlockTab value="WEB">
    ...
    ![打开文件共享客户端页面](../../../img/aBMC_img/v3.0/fileshare_img/06-open-file-share-client-en-steps-v3.png)
    ...
    ![新增 NFS 挂载点](../../../img/aBMC_img/v3.0/fileshare_img/07-add-nfs-mount-point-en-steps-v3.png)
    ...
    ![新增 CIFS 挂载点](../../../img/aBMC_img/v3.0/fileshare_img/08-add-cifs-mount-point-en-steps-v3.png)
    ...
    ![新增 SSHFS 挂载点](../../../img/aBMC_img/v3.0/fileshare_img/09-add-sshfs-mount-point-en-steps-v3.png)
