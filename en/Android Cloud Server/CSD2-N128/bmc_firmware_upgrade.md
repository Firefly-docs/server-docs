...
- Firmware that matches the CSD2-N128 BMC, for example `update.img`.
...
![Connect the OTG port](../../../servers_img/CSD2-N128/bmc_upgrade/bmc_upgrade_usb_port.png)
...
<CodeBlockTabs defaultValue="loader_by_cmd">
  ...
  <CodeBlockTab value="loader_by_button">
    ...
    ![Location of the RECOVER button](../../../servers_img/CSD2-N128/bmc_upgrade/loader_recovery_button.png)
  </CodeBlockTab>
</CodeBlockTabs>
