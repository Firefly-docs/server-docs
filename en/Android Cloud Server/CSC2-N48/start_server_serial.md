...
The debug serial port is on the front panel in the **CONSOLE/HDMI** module, the RJ45 connector in the upper part of the module (the lower one is the HDMI port):

![Debug serial port location](../../../servers_img/CSC2-N48/server_serial.png)
