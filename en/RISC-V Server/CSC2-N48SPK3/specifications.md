...
| **Compute Node Model** | Supports 48 distributed compute nodes |
| **Display Interface** | 1080P HDMI interface |
| **USB** | 2 USB 3.0 ports |
| **Network Interfaces** | - 4 × 10 Gbps SFP+ shared network ports|
| **Console Interface** | 1 × RJ45 Console interface for debugging |
| **Indicators and Buttons** | - 1 POWER button/indicator |
| **Fans** | 4 redundant fans |
| **Screen** | 1 touch display |
...
| Item | Specification |
| :--- | :--- |
| **Dimensions (H×W×D)** | Chassis: 88.8mm (2U) × 430.0mm × 724.0mm |
...
| **Weight (Fully Configured)** | - Net weight: 23.1kg<br/>- Packaging material weight: 25.3kg |
...
![perspective view](../../../servers_img/CSC2-N48SPK3/hw_logical_topology.png)
...
| :--- | :--- | :--- |
| SFP+1 - SFP+4 | SFP+ ports | - The default rate of the 10G optical ports is 10 Gbps.<br/>- In a gigabit network environment, manually switch to 1 Gbps. |
